...
export default class CustomButton extends Component {
  ...
  render() {
    let { text, isApiCall,btnType,font,buttonStyle,textStyle, width,isRightIcon,icon,borderRadius, containerStyle, textColor } = this.props;
    ...
    let whiteBtn = btnType == 'white' ? {backgroundColor:'#fff',borderWidth: 1,borderColor: Colors.accent,} : undefined
    return (
      ...
      <Button
        ...
        titleStyle={{fontFamily: fontType || Fonts.heavy ,fontSize:14,color:btnType == 'white' ? Colors.accent :'#fff' ,...textStyle}}
        icon={
          isRightIcon && (
            <AntDesign
              name={icon}
